...
function ArqueoXmoneda(props) {
  ...
  const postformulario = (event) => {
    event.preventDefault();

    actualizar();
    axios
      .post("https://localhost:44346/api/TbArqueoCentenas/Editar", modelo)
