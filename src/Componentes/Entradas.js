...
function Tabla() {
  ...
  const postform = (idregistro) => {
    axios
      .post(apiconexion + "TbArqueoUnidades/Entrada", [
        {
          intIdMoneda: moneda,
          intIdDenominacion: 1,
        ...
        <div className="card bg-secondary">
          ...
          <div className="card-body text-white">
            ...
            >
              <thead>
                <tr>
                  <th className="text-white">Denomination</th>
                  <th className="text-white">Valor</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <th className="text-white">1000</th>
                  <th>
                    <input
                ...
                <tr>
                  <th className="text-white">500</th>
                  <th>
                    <input
                      className="form-control form-control-sm"
                      type="number"
                ...
                <tr>
                  <th className="text-white">200</th>
                  <th>
                    <input
                      className="form-control form-control-sm"
                      type="number"
                ...
                <tr>
                  <th className="text-white">100</th>
                  <th>
                    <input
                      className="form-control form-control-sm"
                      type="number"
                ...
                <tr>
                  <th className="text-white">0.50</th>
                  <th>
                    <input
                      className="form-control form-control-sm"
                      type="number"
